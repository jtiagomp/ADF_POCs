...
public class JSFUtils {
   ...
   */
    ...
    public static void setHTTPSessionAttributeValues(Map<String, Object> map) {
        ExternalContext ex = getFacesContext().getExternalContext();
    ...
    public static Object getHTTPSessionValue(String attribute) {
        ExternalContext ex = getFacesContext().getExternalContext();
        HttpSession session = (HttpSession) ex.getSession(true);
